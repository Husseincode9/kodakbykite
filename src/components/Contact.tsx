      ...
      <section style={{ padding: '4rem 0.5rem', textAlign: 'center', backgroundColor: '#000000', color: '#FFFFFF' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: '2rem' }}>
          ...
          <a href="mailto:your@email.com" style={{ 
            ...
            boxShadow: '0 0 14px rgba(234, 67, 53, 0.35)',
            border: '2px solid #111111'
          }}
          onMouseEnter={(e) => {
            e.currentTarget.style.transform = 'scale(1.1)';
            e.currentTarget.style.boxShadow = '0 0 22px rgba(234, 67, 53, 0.55)';
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.transform = 'scale(1)';
            e.currentTarget.style.boxShadow = '0 0 14px rgba(234, 67, 53, 0.35)';
          }}
          >
          ...
          {/* Instagram Icon */}
          <a href="https://instagram.com/kodakbykite" target="_blank" rel="noopener noreferrer" style={{ 
            display: 'flex', 
            alignItems: 'center', 
            justifyContent: 'center',
            width: '3rem',
            ...
            textDecoration: 'none',
            transition: 'all 0.3s ease',
            boxShadow: '0 0 14px rgba(220, 39, 67, 0.35)',
            border: '2px solid #111111'
          }}
          onMouseEnter={(e) => {
            e.currentTarget.style.transform = 'scale(1.1)';
            e.currentTarget.style.boxShadow = '0 0 22px rgba(220, 39, 67, 0.55)';
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.transform = 'scale(1)';
            e.currentTarget.style.boxShadow = '0 0 14px rgba(220, 39, 67, 0.35)';
          }}
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          ...
          {/* TikTok Icon */}
          <a href="https://tiktok.com/@kodakbykite" target="_blank" rel="noopener noreferrer" style={{ 
            display: 'flex', 
            alignItems: 'center', 
            justifyContent: 'center',
            width: '3rem',
          ...
          onMouseLeave={(e) => {
            e.currentTarget.style.transform = 'scale(1)';
            e.currentTarget.style.boxShadow = '0 0 14px rgba(0, 0, 0, 0.35)';
          }}
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
