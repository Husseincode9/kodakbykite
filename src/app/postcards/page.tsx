    ...
    <main style={{ padding: "2rem 1rem", backgroundColor: "#000", color: "#fff", minHeight: "100vh", position: "relative" }}>
      ...
      <div style={{ maxWidth: "1600px", margin: "0 auto" }}>
        ...
        <p style={{ 
          ...
          These are all the photos I've taken during my travels, and I'd love for you to have a piece of these memories.
        </p>
        ...
        <div style={{
          ...
          <p style={{
            ...
            To order any of these postcards, simply DM me on Instagram!
          </p>
          <a 
